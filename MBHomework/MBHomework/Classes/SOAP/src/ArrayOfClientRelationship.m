...
@implementation ArrayOfClientRelationship
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"ClientRelationship"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(ClientRelationship*)[__request createObject:child type:[ClientRelationship class]]];
        }
...
{
    for (ClientRelationship* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[ClientRelationship class] name:@"ClientRelationship" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(ClientRelationship*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(ClientRelationship*)anObject {
...
+ (id)array {
	return [[ ArrayOfClientRelationship alloc] init];
}

+ (id)arrayWithObject:(ClientRelationship*)anObject {
	return [[ ArrayOfClientRelationship alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const ClientRelationship* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfClientRelationship alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(ClientRelationship*)firstObj, ... {
	ArrayOfClientRelationship* a = [ ArrayOfClientRelationship array];
	id eachObject;
...
- (id)initWithObjects:(ClientRelationship*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfClientRelationship alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfClientRelationship alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfClientRelationship alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfClientRelationship alloc] initWithCapacity:numItems];
}
