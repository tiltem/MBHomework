...
@implementation ArrayOfStaffFilter

@synthesize items;

+ (ArrayOfStaffFilter *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"StaffFilter"];
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"StaffFilter" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
+ (id)array {
	return [[ ArrayOfStaffFilter alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ ArrayOfStaffFilter alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfStaffFilter alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	ArrayOfStaffFilter* a = [ ArrayOfStaffFilter array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfStaffFilter alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfStaffFilter alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfStaffFilter alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfStaffFilter alloc] initWithCapacity:numItems];
}
