...
@implementation ArrayOfStaff

@synthesize items;

+ (ArrayOfStaff *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"Staff"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(Staff*)[__request createObject:child type:[Staff class]]];
        }
...
{
    for (Staff* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Staff class] name:@"Staff" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (Staff*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(Staff*)anObject {
...
- (BOOL)containsObject:(Staff*)anObject {
...
- (NSUInteger)indexOfObject:(Staff*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(Staff*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Staff*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Staff*)anObject inRange:(NSRange)range {
...
- (void)addObject:(Staff*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(Staff*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(Staff*)anObject {
...
- (void)removeObject:(Staff*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(Staff*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(Staff*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Staff*)anObject {
...
+ (id)array {
	return [[ ArrayOfStaff alloc] init];
}

+ (id)arrayWithObject:(Staff*)anObject {
	return [[ ArrayOfStaff alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Staff* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfStaff alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Staff*)firstObj, ... {
	ArrayOfStaff* a = [ ArrayOfStaff array];
	id eachObject;
...
- (id)initWithObjects:(Staff*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfStaff alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfStaff alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfStaff alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfStaff alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const Staff* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Staff*, Staff*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Staff*, Staff*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(Staff*, Staff*, void *))compare context:(void *)context {
