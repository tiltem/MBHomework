...
+ (ArrayOfString *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"string"];
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"string" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
+ (id)array {
	return [[ ArrayOfString alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ ArrayOfString alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfString alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	ArrayOfString* a = [ ArrayOfString array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfString alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfString alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfString alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfString alloc] initWithCapacity:numItems];
}
