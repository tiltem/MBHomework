...
@implementation ArrayOfClientIndexValue

@synthesize items;

+ (ArrayOfClientIndexValue *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"ClientIndexValue"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(ClientIndexValue*)[__request createObject:child type:[ClientIndexValue class]]];
        }
...
{
    for (ClientIndexValue* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[ClientIndexValue class] name:@"ClientIndexValue" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (ClientIndexValue*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(ClientIndexValue*)anObject {
...
- (BOOL)containsObject:(ClientIndexValue*)anObject {
...
- (NSUInteger)indexOfObject:(ClientIndexValue*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(ClientIndexValue*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(ClientIndexValue*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(ClientIndexValue*)anObject inRange:(NSRange)range {
...
- (void)addObject:(ClientIndexValue*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(ClientIndexValue*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(ClientIndexValue*)anObject {
...
- (void)removeObject:(ClientIndexValue*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(ClientIndexValue*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(ClientIndexValue*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(ClientIndexValue*)anObject {
...
+ (id)array {
	return [[ ArrayOfClientIndexValue alloc] init];
}

+ (id)arrayWithObject:(ClientIndexValue*)anObject {
	return [[ ArrayOfClientIndexValue alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const ClientIndexValue* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfClientIndexValue alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(ClientIndexValue*)firstObj, ... {
	ArrayOfClientIndexValue* a = [ ArrayOfClientIndexValue array];
	id eachObject;
...
- (id)initWithObjects:(ClientIndexValue*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfClientIndexValue alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfClientIndexValue alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfClientIndexValue alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfClientIndexValue alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const ClientIndexValue* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(ClientIndexValue*, ClientIndexValue*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(ClientIndexValue*, ClientIndexValue*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(ClientIndexValue*, ClientIndexValue*, void *))compare context:(void *)context {
