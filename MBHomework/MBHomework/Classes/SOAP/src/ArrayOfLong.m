...
@implementation ArrayOfLong

@synthesize items;

+ (ArrayOfLong *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"long"];
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"long" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
+ (id)array {
	return [[ ArrayOfLong alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ ArrayOfLong alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfLong alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	ArrayOfLong* a = [ ArrayOfLong array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfLong alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfLong alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfLong alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfLong alloc] initWithCapacity:numItems];
}
