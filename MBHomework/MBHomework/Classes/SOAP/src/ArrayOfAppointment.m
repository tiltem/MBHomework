...
@implementation ArrayOfAppointment

@synthesize items;

+ (ArrayOfAppointment *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"Appointment"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(Appointment*)[__request createObject:child type:[Appointment class]]];
        }
...
{
    for (Appointment* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Appointment class] name:@"Appointment" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (Appointment*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(Appointment*)anObject {
...
- (BOOL)containsObject:(Appointment*)anObject {
...
- (NSUInteger)indexOfObject:(Appointment*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(Appointment*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Appointment*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Appointment*)anObject inRange:(NSRange)range {
...
- (void)addObject:(Appointment*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(Appointment*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(Appointment*)anObject {
...
- (void)removeObject:(Appointment*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(Appointment*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(Appointment*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Appointment*)anObject {
...
+ (id)array {
	return [[ ArrayOfAppointment alloc] init];
}

+ (id)arrayWithObject:(Appointment*)anObject {
	return [[ ArrayOfAppointment alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Appointment* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfAppointment alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Appointment*)firstObj, ... {
	ArrayOfAppointment* a = [ ArrayOfAppointment array];
	id eachObject;
...
- (id)initWithObjects:(Appointment*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfAppointment alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfAppointment alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfAppointment alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfAppointment alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const Appointment* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Appointment*, Appointment*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Appointment*, Appointment*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(Appointment*, Appointment*, void *))compare context:(void *)context {
