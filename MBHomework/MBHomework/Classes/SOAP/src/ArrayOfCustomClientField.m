...
@implementation ArrayOfCustomClientField

@synthesize items;

+ (ArrayOfCustomClientField *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"CustomClientField"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(CustomClientField*)[__request createObject:child type:[CustomClientField class]]];
        }
...
{
    for (CustomClientField* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[CustomClientField class] name:@"CustomClientField" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (CustomClientField*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(CustomClientField*)anObject {
...
- (BOOL)containsObject:(CustomClientField*)anObject {
...
- (NSUInteger)indexOfObject:(CustomClientField*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(CustomClientField*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(CustomClientField*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(CustomClientField*)anObject inRange:(NSRange)range {
...
- (void)addObject:(CustomClientField*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(CustomClientField*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(CustomClientField*)anObject {
...
- (void)removeObject:(CustomClientField*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(CustomClientField*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(CustomClientField*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(CustomClientField*)anObject {
...
+ (id)array {
	return [[ ArrayOfCustomClientField alloc] init];
}

+ (id)arrayWithObject:(CustomClientField*)anObject {
	return [[ ArrayOfCustomClientField alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const CustomClientField* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfCustomClientField alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(CustomClientField*)firstObj, ... {
	ArrayOfCustomClientField* a = [ ArrayOfCustomClientField array];
	id eachObject;
...
- (id)initWithObjects:(CustomClientField*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfCustomClientField alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfCustomClientField alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfCustomClientField alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfCustomClientField alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const CustomClientField* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(CustomClientField*, CustomClientField*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(CustomClientField*, CustomClientField*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(CustomClientField*, CustomClientField*, void *))compare context:(void *)context {
