...
+ (ArrayOfInt *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"int"];
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"int" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
+ (id)array {
	return [[ ArrayOfInt alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ ArrayOfInt alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfInt alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	ArrayOfInt* a = [ ArrayOfInt array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfInt alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfInt alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfInt alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfInt alloc] initWithCapacity:numItems];
}
