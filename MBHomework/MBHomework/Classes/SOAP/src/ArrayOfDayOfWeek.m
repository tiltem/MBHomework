...
@implementation ArrayOfDayOfWeek

@synthesize items;

+ (ArrayOfDayOfWeek *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"DayOfWeek"];
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"DayOfWeek" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
+ (id)array {
	return [[ ArrayOfDayOfWeek alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ ArrayOfDayOfWeek alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfDayOfWeek alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	ArrayOfDayOfWeek* a = [ ArrayOfDayOfWeek array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfDayOfWeek alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfDayOfWeek alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfDayOfWeek alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfDayOfWeek alloc] initWithCapacity:numItems];
}
