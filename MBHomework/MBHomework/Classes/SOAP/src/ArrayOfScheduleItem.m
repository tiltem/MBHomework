...
@implementation ArrayOfScheduleItem

@synthesize items;

+ (ArrayOfScheduleItem *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"ScheduleItem"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(ScheduleItem*)[__request createObject:child type:[ScheduleItem class]]];
        }
...
{
    for (ScheduleItem* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[ScheduleItem class] name:@"ScheduleItem" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (ScheduleItem*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(ScheduleItem*)anObject {
...
- (BOOL)containsObject:(ScheduleItem*)anObject {
...
- (NSUInteger)indexOfObject:(ScheduleItem*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(ScheduleItem*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(ScheduleItem*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(ScheduleItem*)anObject inRange:(NSRange)range {
...
- (void)addObject:(ScheduleItem*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(ScheduleItem*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(ScheduleItem*)anObject {
...
- (void)removeObject:(ScheduleItem*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(ScheduleItem*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(ScheduleItem*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(ScheduleItem*)anObject {
...
+ (id)array {
	return [[ ArrayOfScheduleItem alloc] init];
}

+ (id)arrayWithObject:(ScheduleItem*)anObject {
	return [[ ArrayOfScheduleItem alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const ScheduleItem* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfScheduleItem alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(ScheduleItem*)firstObj, ... {
	ArrayOfScheduleItem* a = [ ArrayOfScheduleItem array];
	id eachObject;
...
- (id)initWithObjects:(ScheduleItem*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfScheduleItem alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfScheduleItem alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfScheduleItem alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfScheduleItem alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const ScheduleItem* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(ScheduleItem*, ScheduleItem*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(ScheduleItem*, ScheduleItem*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(ScheduleItem*, ScheduleItem*, void *))compare context:(void *)context {
