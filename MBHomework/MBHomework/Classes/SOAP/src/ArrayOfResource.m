...
@implementation ArrayOfResource

@synthesize items;

+ (ArrayOfResource *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"Resource"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(Resource*)[__request createObject:child type:[Resource class]]];
        }
...
{
    for (Resource* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Resource class] name:@"Resource" URI:@"http://clients.mindbodyonline.com/api/0_5" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (Resource*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(Resource*)anObject {
...
- (BOOL)containsObject:(Resource*)anObject {
...
- (NSUInteger)indexOfObject:(Resource*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(Resource*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Resource*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Resource*)anObject inRange:(NSRange)range {
...
- (void)addObject:(Resource*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(Resource*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(Resource*)anObject {
...
- (void)removeObject:(Resource*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(Resource*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(Resource*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Resource*)anObject {
...
+ (id)array {
	return [[ ArrayOfResource alloc] init];
}

+ (id)arrayWithObject:(Resource*)anObject {
	return [[ ArrayOfResource alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Resource* *)objects count:(NSUInteger)cnt {
	return [[ ArrayOfResource alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Resource*)firstObj, ... {
	ArrayOfResource* a = [ ArrayOfResource array];
	id eachObject;
...
- (id)initWithObjects:(Resource*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ ArrayOfResource alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ ArrayOfResource alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ ArrayOfResource alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ ArrayOfResource alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const Resource* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Resource*, Resource*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Resource*, Resource*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(Resource*, Resource*, void *))compare context:(void *)context {
